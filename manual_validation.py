...
def segmentTestExp():
    ...
    dir = '/hdd/RecPAIR/Microscopy/EXP-21-BV3242 liveRuns/exp7/Pos0/aphase'

    res_dir = '/hdd/RecPAIR/Microscopy/EXP-21-BV3242 liveRuns/experimental_segmentation_exp7_pos0'
    ...
    for fi, f in enumerate(images):
        ...
        res = res.astype('uint16')
        filename = f.split('/')[-1]
        io.imsave(os.path.join(res_dir,filename),res)
